            ...
            <div className="container mx-auto px-6 py-6">
              <nav className="space-y-4">
                ...
                >
                  ...
                  <span className="text-base font-normal tracking-20-smaller">Home</span>
                </Link>
                <Link
                  href="/products"
                  onClick={closeMenu}
                ...
                >
                  ...
                  <span className="text-base font-normal tracking-20-smaller">Products</span>
                </Link>
                <Link
                  href="/status"
                  onClick={closeMenu}
                ...
                >
                  ...
                  <span className="text-base font-normal tracking-20-smaller">Status</span>
                </Link>
                <Link
                  href="#"
                  onClick={closeMenu}
                ...
                >
                  ...
                  <span className="text-base font-normal tracking-20-smaller">Support</span>
                </Link>
