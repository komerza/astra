      ...
      <div className="container mx-auto h-full flex items-center justify-between px-4 sm:px-6">
          ...
          <div className="items-center gap-4 hidden md:flex">
            <Link
              ...
              className={`flex items-center gap-2 rounded-md px-2.5 py-1.5 transition-colors duration-300 ${
                isLandingPage
                  ? "text-[#3B82F6] hover:text-[#3B82F6] hover:bg-[#3B82F6]/10 bg-[#3B82F6]/10"
                  : "text-theme-secondary hover:text-[#3B82F6] hover:bg-[#3B82F6]/10 bg-transparent"
              }`}
            >
        ...
        <div className="flex items-center gap-4">
          ...
          <Button
            variant="ghost"
            size="sm"
            className="md:hidden p-2 h-auto text-theme-secondary hover:text-[#3B82F6] hover:bg-[#3B82F6]/10"
      ...
      {isMobileMenuOpen && (
        <div className="md:hidden bg-white/95 dark:bg-black/95 backdrop-blur-md border-t border-gray-200 dark:border-gray-800">
          <div className="container mx-auto px-4 py-4 space-y-4">
            ...
            <Link
              to="/dashboard/support"
              className="flex items-center gap-3 rounded-md px-3 py-2 text-theme-secondary hover:text-[#3B82F6] hover:bg-[#3B82F6]/10 transition-colors duration-300"
              onClick={() => setIsMobileMenuOpen(false)}
            >
            ...
            <div className="border-t border-gray-200 dark:border-gray-800 pt-4 space-y-4">
              ...
              <Link
                ...
                onClick={() => setIsMobileMenuOpen(false)}
              >
                <Button className="w-full bg-[#3B82F6] text-white hover:bg-[#2563EB] h-10 px-4 py-2 rounded-md flex items-center justify-center gap-2 text-base transition-all duration-300 font-normal">
                  <span>Client Area</span>
